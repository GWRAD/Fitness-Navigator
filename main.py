...
def main(mp_drawing, mp_pose, cap, screenshots):
    with mp_pose.Pose(min_detection_confidence=0.5,
        ...
        while cap.isOpened():
            ...
            cv2.imshow('Fitness Navigator', frame)
            cv2.setMouseCallback('Fitness Navigator', mouse_callback)
        ...
        logger.info("Finish exercising. Thanks for using Fitness Navigator!")
        cap.release()
        cv2.destroyAllWindows()
